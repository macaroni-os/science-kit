...
SRC_URI="https://github.com/OSGeo/libgeotiff/tarball/0a4295774fba2eff19d2129b39e4668eaf213402 -> libgeotiff-1.7.4-0a42957.tar.gz"
...
post_src_unpack() {
	if [ ! -d "${WORKDIR}/${S}" ]; then
		mv "${WORKDIR}"/OSGeo-libgeotiff-0a42957/libgeotiff "${S}" || die
	fi
}
